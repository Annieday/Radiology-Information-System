				...
				if(cmp(oldEmail,newEmail)==false){
					if(checkEmailUnique(con,newEmail,person_id)){
						...
						if(userClass.equals("A")){
							...
							out.println("<FORM NAME='AbortForm' ACTION='RadPage.jsp' METHOD='get'>"); 
						}
						else if(userClass.equals("P")){
							out.println("<FORM NAME='AbortForm' ACTION='PatientPage.jsp' METHOD='get'>"); 
						}
						else{
							out.println("<FORM NAME='AbortForm' ACTION='DoctorPage.jsp' METHOD='get'>"); 
						}
