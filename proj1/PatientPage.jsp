...
<BODY background="BGP.jpg">
	...
	<%
			if(session.getAttribute("class") != null && ((String)session.getAttribute("class")).equals("p")){
				...
				if (canConnect){
					...
					out.println("<H1><CENTER><font color =Teal>Welcome! Patient <a href='PersonalManage.jsp?Manage=1'><b>"+first_name+" "+last_name+"</b></a> You can:</font></CENTER></H1>");
				}
				try{
					con.close();
				}
	...
	<BR></BR>
	<CENTER>
		<H3><a href="Search.jsp?SearchRequest=1"><b>Search for radiology records</b></a></H3>
	</CENTER>
	<BR></BR>
	<HR></HR>
	<BR></BR>
